========================================================================
    ACTIVE TEMPLATE LIBRARY : MenuEx Project Overview
========================================================================

AppWizard has created this MenuEx project for you to use as the starting point for
...
MenuEx.idl
    ...
    This file will be processed by the MIDL compiler to generate:
        C++ interface definitions and GUID declarations (MenuEx.h)
        GUID definitions                                (MenuEx_i.c)
        A type library                                  (MenuEx.tlb)
        Marshaling code                                 (MenuEx_p.c and dlldata.c)

MenuEx.h
    This file contains the C++ interface definitions and GUID declarations of the
    items defined in MenuEx.idl. It will be regenerated by MIDL during compilation.
...
StdAfx.h, StdAfx.cpp
    ...
    named MenuEx.pch and a precompiled types file named StdAfx.obj.
