========================================================================
    ACTIVE TEMPLATE LIBRARY : FileIcon Project Overview
========================================================================

AppWizard has created this FileIcon project for you to use as the starting point for
...
FileIcon.idl
    ...
    This file will be processed by the MIDL compiler to generate:
        C++ interface definitions and GUID declarations (FileIcon.h)
        GUID definitions                                (FileIcon_i.c)
        A type library                                  (FileIcon.tlb)
        Marshaling code                                 (FileIcon_p.c and dlldata.c)

FileIcon.h
    This file contains the C++ interface definitions and GUID declarations of the
    items defined in FileIcon.idl. It will be regenerated by MIDL during compilation.
...
StdAfx.h, StdAfx.cpp
    ...
    named FileIcon.pch and a precompiled types file named StdAfx.obj.
...
FileIconps.vcxproj
	...
	dlldata.c, FileIcon_i.c and FileIcon_p.c which are required
	to build the proxy/stub DLL.

FileIconps.vcxproj.filters
