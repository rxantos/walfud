========================================================================
    ACTIVE TEMPLATE LIBRARY : DropOnTarget Project Overview
========================================================================

AppWizard has created this DropOnTarget project for you to use as the starting point for
...
DropOnTarget.idl
    ...
    This file will be processed by the MIDL compiler to generate:
        C++ interface definitions and GUID declarations (DropOnTarget.h)
        GUID definitions                                (DropOnTarget_i.c)
        A type library                                  (DropOnTarget.tlb)
        Marshaling code                                 (DropOnTarget_p.c and dlldata.c)

DropOnTarget.h
    This file contains the C++ interface definitions and GUID declarations of the
    items defined in DropOnTarget.idl. It will be regenerated by MIDL during compilation.
...
StdAfx.h, StdAfx.cpp
    ...
    named DropOnTarget.pch and a precompiled types file named StdAfx.obj.
